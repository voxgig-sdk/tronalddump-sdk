...
| --- | --- | --- | --- |
| Author | `load` | `GET /author/{author_id}` | See reference |
| Author | `load` | `GET /author` | See reference |
| Quote | `list` | `GET /random/quote` | See reference |
| Quote | `load` | `GET /search/quote` | See reference |
| Quote | `load` | `GET /quote/{quote_id}` | See reference |
| Source | `load` | `GET /source/{source_id}` | See reference |
| Source | `load` | `GET /source` | See reference |
| Tag | `load` | `GET /tag/{tag_value}` | See reference |
| Tag | `load` | `GET /tag` | See reference |

## Connect to the API

- Production server: `https://api.tronalddump.io`
...
- `tronalddump_list`: List records for an entity. Supported entities: `quote`.
- `tronalddump_load`: Load one record for an entity. Supported entities: `author`, `quote`, `source`, `tag`.
