...
func registerSDKWords(r *eng.Registry, client *sdk.TronalddumpSDK) {
...
func runOp(client *sdk.TronalddumpSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
