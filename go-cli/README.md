...
AQL-driven CLI and REPL for the Tronalddump SDK. Positional arguments are
...
./tronalddump-cli list author
./tronalddump-cli load 1 author
./tronalddump-cli load '{id:1}' author
