// Command Tronalddump-cli is a CLI + REPL for the Tronalddump SDK,
...
const prompt = "tronalddump"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "author quote source tag"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      TRONALDDUMP_APIKEY (api key), TRONALDDUMP_BASE (base url override)")
