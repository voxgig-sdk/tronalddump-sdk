...
The Lua SDK for the Tronalddump API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:Tronalddump(nil):load(
  { id = "test01" }, nil
)
...
```
lua/
├── tronalddump_sdk.lua    -- Main SDK module
...
The main module (`tronalddump_sdk`) exports the SDK constructor
