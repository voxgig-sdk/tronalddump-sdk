...
local TronalddumpSDK = {}
TronalddumpSDK.__index = TronalddumpSDK
...
TronalddumpSDK._make_feature = _make_feature


function TronalddumpSDK.new(options)
  local self = setmetatable({}, TronalddumpSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TronalddumpSDK:options_map()
...
function TronalddumpSDK:get_utility()
  return Utility.copy(self._utility)
end


function TronalddumpSDK:get_root_ctx()
  return self._rootctx
end


function TronalddumpSDK:prepare(fetchargs)
...
function TronalddumpSDK:direct(fetchargs)
...
-- by passing it.
function TronalddumpSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TronalddumpSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TronalddumpSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TronalddumpSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TronalddumpSDK.new(sdkopts)
  sdk.mode = "test"
