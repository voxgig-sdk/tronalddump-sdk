...
describe("SourceDirect", function()
  it("should direct-load-source", function()
    local setup = source_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-source", setup.live and "live" or "unit")
...
function source_direct_setup(mockres)
