...
function runner.env_override(m)
  local live = runner.getenv("TRONALDDUMP_TEST_LIVE")
  local override = runner.getenv("TRONALDDUMP_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TRONALDDUMP_TEST_EXPLAIN")
