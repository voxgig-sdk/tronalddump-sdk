// Command Tronalddump-mcp is an MCP server exposing the Tronalddump
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Tronalddump_list  — list records of an entity
//	Tronalddump_load  — load a single record of an entity
//
...
func main() {
	...
	client := sdk.NewTronalddumpSDK(nil)
