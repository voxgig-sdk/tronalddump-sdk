...
type Args struct {
	Entity string         `json:"entity" jsonschema:"author | quote | source | tag"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TronalddumpSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "tronalddump_list",
		Description: "List records from Tronalddump. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "tronalddump_load",
		Description: "Load a single record from Tronalddump. " +
...
func runOp(client *sdk.TronalddumpSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TronalddumpSDK, name string) (sdk.TronalddumpEntity, error) {
