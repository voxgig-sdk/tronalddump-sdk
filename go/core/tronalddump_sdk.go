...
func (sdk *TronalddumpSDK) OptionsMap() map[string]any {
...
func (sdk *TronalddumpSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TronalddumpSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TronalddumpSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TronalddumpSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TronalddumpSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TronalddumpSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TronalddumpSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TronalddumpSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TronalddumpSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TronalddumpSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
