...
```bash
go mod edit -replace github.com/voxgig-sdk/tronalddump-sdk/go=../path/to/github.com/voxgig-sdk/tronalddump-sdk/go
```
...
```
github.com/voxgig-sdk/tronalddump-sdk/go/
...
The root package (`github.com/voxgig-sdk/tronalddump-sdk/go`) re-exports everything needed
