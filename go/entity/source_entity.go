...
func NewSourceEntity(client *core.TronalddumpSDK, entopts map[string]any) *SourceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SourceEntity) GetName() string { return e.name }
...
func (e *SourceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SourceEntity) Deleted() bool {
	return e.deleted
}


func (e *SourceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSourceEntity(e.client, opts)
}

func (e *SourceEntity) Data(args ...any) any {
...
func (e *SourceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Source; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SourceEntity) DataTyped(data ...Source) Source {
	if len(data) > 0 {
		return typedFrom[Source](e.Data(asMap(data[0])))
	}
	return typedFrom[Source](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Source (all fields
// optional at the wire level).
func (e *SourceEntity) MatchTyped(match ...Source) Source {
	if len(match) > 0 {
		return typedFrom[Source](e.Match(asMap(match[0])))
	}
	return typedFrom[Source](e.Match())
}
...
func (e *SourceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SourceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SourceLoadMatch and returns an Source. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SourceEntity) LoadTyped(reqmatch SourceLoadMatch, ctrl map[string]any) (Source, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Source{}, err
	}
	return typedFrom[Source](res), nil
}



func (e *SourceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SourceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SourceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SourceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SourceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
