# Tronalddump Python SDK



The Python SDK for the Tronalddump API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/tronalddump-sdk/releases)) or
...
| Field | Type | Description |
| --- | --- | --- |
| `appeared_at` | `str` | The date and time when the quote appeared |
...
| `updated_at` | `str` | The date and time when the quote was last updated |
| `value` | `str` | The actual quote text |
...
```
py/
├── tronalddump_sdk.py         -- Main SDK module
