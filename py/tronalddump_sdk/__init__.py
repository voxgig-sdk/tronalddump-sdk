...
from tronalddump_sdk.utility import register

# Load features
from tronalddump_sdk.feature.base_feature import TronalddumpBaseFeature
from tronalddump_sdk.features import _has_feature, _make_feature
...
class TronalddumpSDK:
    ...
    def get_utility(self):
        return TronalddumpUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TronalddumpSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Author(self, data=None) -> "AuthorEntity":
        ...
        from tronalddump_sdk.entity.author_entity import AuthorEntity
        return AuthorEntity(self, data)


    def Quote(self, data=None) -> "QuoteEntity":
        """Entity factory: client.Quote().list() / client.Quote().load({"id": ...})."""
        from tronalddump_sdk.entity.quote_entity import QuoteEntity
    ...
    def Source(self, data=None) -> "SourceEntity":
        ...
        from tronalddump_sdk.entity.source_entity import SourceEntity
        return SourceEntity(self, data)


    def Tag(self, data=None) -> "TagEntity":
        """Entity factory: client.Tag().list() / client.Tag().load({"id": ...})."""
        from tronalddump_sdk.entity.tag_entity import TagEntity
