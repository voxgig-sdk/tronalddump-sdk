# Tronalddump SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TronalddumpSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TronalddumpSDK(...) and TronalddumpSDK.test(...) become
#      TronalddumpSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tronalddump_sdk"
_SDK_CLASS = "TronalddumpSDK"
