...
from projectname_sdk.core.control import TronalddumpControl
...
class TronalddumpContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TronalddumpSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TronalddumpResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TronalddumpResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TronalddumpError(code, msg, self)
