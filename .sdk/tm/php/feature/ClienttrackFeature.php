...
// Tronalddump SDK clienttrack feature
...
class TronalddumpClienttrackFeature extends TronalddumpBaseFeature
{
    ...
    public function PostConstruct(TronalddumpContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Tronalddump-SDK';
