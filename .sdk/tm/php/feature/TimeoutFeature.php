...
// Tronalddump SDK timeout feature
...
class TronalddumpTimeoutFeature extends TronalddumpBaseFeature
{
    ...
    private function _with_timeout(TronalddumpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TronalddumpContext $_ctx, float $ms): void
    {
        $client = $this->client;
