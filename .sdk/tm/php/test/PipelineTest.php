...
{
    private static function utility(): TronalddumpUtility
    {
        return new TronalddumpUtility();
    }
    ...
    private static function ctx(array $over = []): TronalddumpContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TronalddumpContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TronalddumpOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TronalddumpError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TronalddumpOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TronalddumpMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TronalddumpOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TronalddumpMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TronalddumpOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TronalddumpMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TronalddumpSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TronalddumpMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TronalddumpResponse([]),
            'result' => new TronalddumpResult([]),
        ]);
        [, $err] = TronalddumpMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TronalddumpSpec([]),
            'response' => null,
            'result' => new TronalddumpResult([]),
        ]);
        [, $err] = TronalddumpMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TronalddumpSpec(['step' => 's']),
            'response' => new TronalddumpResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TronalddumpResult([]),
        ]);
        [, $err] = TronalddumpMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TronalddumpSpec(['step' => 's']),
            'response' => new TronalddumpResponse(self::resp(200, ['v' => 1])),
            'result' => new TronalddumpResult([]),
        ]);
        [, $err] = TronalddumpMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TronalddumpSpec(['step' => 's']),
            'response' => new TronalddumpResponse(self::resp(200, ['v' => 2])),
            'result' => new TronalddumpResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TronalddumpMakeResponse::call($ctx);
    ...
    {
        $preset = new TronalddumpResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TronalddumpSpec([]),
            'response' => new TronalddumpResponse([]),
            'result' => new TronalddumpResult([]),
        ...
        [$got, $err] = TronalddumpMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TronalddumpResult([])]);
        [, $err] = TronalddumpMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TronalddumpSpec([]), 'result' => null]);
        [, $err] = TronalddumpMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TronalddumpSpec(['step' => 's']),
            'result' => new TronalddumpResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TronalddumpOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TronalddumpMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TronalddumpSpec(['step' => 's']),
            'result' => new TronalddumpResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TronalddumpOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TronalddumpMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TronalddumpResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TronalddumpSpec([]),
            'result' => new TronalddumpResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TronalddumpMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TronalddumpMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TronalddumpError('boom', 'boom');
        $utility->fetcher = function (TronalddumpContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TronalddumpSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TronalddumpMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TronalddumpContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TronalddumpMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TronalddumpResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TronalddumpMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TronalddumpContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TronalddumpSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TronalddumpMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TronalddumpResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TronalddumpSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TronalddumpMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TronalddumpMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TronalddumpMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TronalddumpResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TronalddumpDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TronalddumpResult(['ok' => false])]);
        $this->expectException(TronalddumpError::class);
        TronalddumpDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TronalddumpResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TronalddumpMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TronalddumpMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TronalddumpBaseFeature();
        $b = new TronalddumpBaseFeature();
        TronalddumpFeatureAdd::call($ctx, $a);
        TronalddumpFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TronalddumpBaseFeature
    {
        $f = new TronalddumpBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TronalddumpFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?TronalddumpSpec $spec): TronalddumpContext
    {
    ...
    private static function auth_bags(): TronalddumpSpec
    {
        return new TronalddumpSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        TronalddumpPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TronalddumpPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TronalddumpResponse(['headers' => null]),
            'result' => new TronalddumpResult([]),
        ]);
        TronalddumpResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TronalddumpResultBody::call($ctx);
