...
// Tronalddump SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TronalddumpOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TronalddumpOmni::structfix($now, Struct::undef()))
                        !== json_encode(TronalddumpOmni::structfix($val, Struct::undef()))) {
