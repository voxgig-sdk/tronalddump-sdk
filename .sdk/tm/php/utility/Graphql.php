...
// Tronalddump SDK utility: graphql
//
...
class TronalddumpGraphql
{
    ...
    // equivalent.
    public static function body(TronalddumpContext $ctx): mixed
    {
    ...
    public static function errors(TronalddumpContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
