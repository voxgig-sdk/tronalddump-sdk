...
module TronalddumpTestRunner
  ...
  def self.env_override(m)
    live = getenv("TRONALDDUMP_TEST_LIVE")
    override = getenv("TRONALDDUMP_TEST_OVERRIDE")
    ...
    explain = getenv("TRONALDDUMP_TEST_EXPLAIN")
    m["TRONALDDUMP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = TronalddumpTestRunner
Helpers = TronalddumpHelpers
Vs = VoxgigStruct
