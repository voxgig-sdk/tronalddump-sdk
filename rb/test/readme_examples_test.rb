...
#      offline in seeded test mode (TronalddumpSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Tronalddump_sdk.rb")
  SDK_CLASS = "TronalddumpSDK"
