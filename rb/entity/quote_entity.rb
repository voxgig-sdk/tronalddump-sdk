...
class QuoteEntity
  ...
  # @return [Quote, Hash] the loaded Quote; raises TronalddumpError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Quote>, Array] the matching Quote items; raises TronalddumpError on failure
