...
(0, node_test_1.describe)('SourceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-source', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-source', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TRONALDDUMP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TronalddumpSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TRONALDDUMP_TEST_SOURCE_ENTID'];
    ...
    const client = new __1.TronalddumpSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SourceDirect.test.js.map