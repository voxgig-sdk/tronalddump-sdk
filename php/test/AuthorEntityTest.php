...
class AuthorEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TRONALDDUMP_TEST_AUTHOR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function author_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TRONALDDUMP_TEST_AUTHOR_ENTID");
