...
class SourceDirectTest extends TestCase
{
    public function test_direct_load_source(): void
    {
        $setup = source_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-source", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
