...
class TronalddumpTestRunner
{
    ...
    {
        $live = self::getenv('TRONALDDUMP_TEST_LIVE');
        $override = self::getenv('TRONALDDUMP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TRONALDDUMP_TEST_EXPLAIN');
...
class_alias('TronalddumpTestRunner', 'Runner');
class_alias('TronalddumpHelpers', 'Helpers');
