...
// Tronalddump SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TronalddumpSDK::test)
...
{
    private const SDK_CLASS = 'TronalddumpSDK';
    ...
    private const SDK_BASE = 'tronalddump_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../tronalddump_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
