...
// Tronalddump SDK metrics feature
...
class TronalddumpMetricsFeature extends TronalddumpBaseFeature
{
    ...
    private function _record(TronalddumpContext $ctx, bool $ok): void
    {
