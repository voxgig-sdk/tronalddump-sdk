...
// Tronalddump SDK ratelimit feature
...
class TronalddumpRatelimitFeature extends TronalddumpBaseFeature
{
    ...
    private function _acquire(TronalddumpContext $ctx): void
    {
    ...
    private function _track(TronalddumpContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
