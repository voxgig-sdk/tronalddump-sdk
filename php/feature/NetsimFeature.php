...
// Tronalddump SDK netsim feature
...
class TronalddumpNetsimFeature extends TronalddumpBaseFeature
{
    ...
    private function _simulate(TronalddumpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TronalddumpContext $ctx, array $applied): void
    {
        $client = $this->client;
