...
class TronalddumpProxyFeature extends TronalddumpBaseFeature
{
    ...
    public function init(TronalddumpContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TronalddumpContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
