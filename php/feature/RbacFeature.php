...
class TronalddumpRbacFeature extends TronalddumpBaseFeature
{
    ...
    private function _required(TronalddumpContext $ctx): ?string
    {
    ...
    private function _reject(TronalddumpContext $ctx, string $required): void
    {
    ...
    private function _track(TronalddumpContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
