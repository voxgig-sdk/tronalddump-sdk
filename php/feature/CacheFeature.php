...
class TronalddumpCacheFeature extends TronalddumpBaseFeature
{
    ...
    private function _through(TronalddumpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
