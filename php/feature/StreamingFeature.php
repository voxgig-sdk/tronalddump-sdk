...
// Tronalddump SDK streaming feature
...
class TronalddumpStreamingFeature extends TronalddumpBaseFeature
{
    ...
    private function _iterate(TronalddumpResult $result): \Generator
    {
    ...
    private function _streamable(TronalddumpContext $ctx): bool
    {
