...
// Tronalddump SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TronalddumpTestFeature extends TronalddumpBaseFeature
{
    ...
    public function init(TronalddumpContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TronalddumpContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TronalddumpParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TronalddumpContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TronalddumpContext $ctx, $op, $args): array
    {
