...
// Tronalddump SDK telemetry feature
...
class TronalddumpTelemetryFeature extends TronalddumpBaseFeature
{
    ...
    private function _close(TronalddumpContext $ctx, bool $ok): void
    {
