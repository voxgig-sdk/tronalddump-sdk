...
class TronalddumpFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TronalddumpSDK/1.0)';
    ...
    public static function call(TronalddumpContext $ctx, string $fullurl, array $fetchdef): array
    {
